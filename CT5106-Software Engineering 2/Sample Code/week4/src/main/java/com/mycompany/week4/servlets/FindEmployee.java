 ...
 * @author o_molloy
 */
@WebServlet(name = "FindEmployee", urlPatterns =
{
    "/FindEmployee"
})
public class FindEmployee extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        if (e != null)
        {
            ...
            session.setAttribute("employeeFound", e);

            RequestDispatcher dispatcher = request.getRequestDispatcher("displayEmployee.jsp");
            dispatcher.forward(request, response);
        } else
        {
            RequestDispatcher dispatcher = request.getRequestDispatcher("findEmployee.html");
            dispatcher.forward(request, response);
        }
    }
